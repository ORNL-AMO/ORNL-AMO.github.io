...
\index{Turbine@{Turbine}!Turbine@{Turbine}}
\subsubsection{\texorpdfstring{Turbine()}{Turbine()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{Turbine@{Turbine}!Turbine@{Turbine}}
\index{Turbine@{Turbine}!Turbine@{Turbine}}
\subsubsection{\texorpdfstring{Turbine()}{Turbine()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\subsubsection{\texorpdfstring{get\+Energy\+Out()}{getEnergyOut()}}
...
\index{Turbine@{Turbine}!get\+Solve\+For@{get\+Solve\+For}}
\index{get\+Solve\+For@{get\+Solve\+For}!Turbine@{Turbine}}
